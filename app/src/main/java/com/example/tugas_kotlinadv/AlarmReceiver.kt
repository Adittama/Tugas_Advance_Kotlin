package com.example.tugas_kotlinadv
...
class AlarmReceiver : BroadcastReceiver() {
    ...
    var NOTIFICATION_CHANNEL_ID = "tubianto.com"
    var NOTIFICATION_CHANNEL_NAME = "tubianto.com"
    ...
    private fun playAudio(context: Context) {
        val mediaPlayer = MediaPlayer.create(context, R.raw.chloe)
        mediaPlayer.start()
    }
